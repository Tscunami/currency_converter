...
equation_label = Label(text="=", font=FONT)
result_czk_label = Label(text="", font=FONT)
result_dollars_label = Label(text="", font=FONT)
result_euros_label = Label(text="", font=FONT)
equation_label.grid(column=0, row=3)
result_czk_label.grid(column=0, row=4)
result_dollars_label.grid(column=0, row=5)
result_euros_label.grid(column=0, row=6)
